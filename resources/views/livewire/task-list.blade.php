<div>
    <input type="text" wire:model.live="search" class="border-gray-300 dark:bg-gray-700 dark:text-white px-4 py-2 rounded-md w-full" placeholder="Search tasks...">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100 flex space-x-3">
                            ...
                            @if (auth()->user()->is_admin || auth()->id() === $task->user_id)
                                <a href="{{ route('tasks.edit', $task->id) }}" class="text-blue-500 hover:text-blue-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M11 4H9a2 2 0 00-2 2v12a2 2 0 002 2h6a2 2 0 002-2v-5M16 3.13a2.5 2.5 0 013.54 3.54L11 15l-4 1 1-4L16 3.13z" />
                                    </svg>
                                </a>
